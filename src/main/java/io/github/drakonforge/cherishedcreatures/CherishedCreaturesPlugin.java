...
import io.github.drakonforge.cherishedcreatures.system.mount.ResetMountHandlingNpcSystem;
...
public class CherishedCreaturesPlugin extends JavaPlugin {
    ...
    protected void setup() {
        ...
        this.petAttributesComponentType = entityStoreRegistry.registerComponent(PetAttributes.class, "PetAttributes", PetAttributes.CODEC);
        ...
        entityStoreRegistry.registerSystem(new ResetMountHandlingNpcSystem());
        // Mount Handling ticking logic - order matters when loading
    ...
    public ComponentType<EntityStore, PetAttributes> getPetAttributesComponentType() {
        return petAttributesComponentType;
    }
