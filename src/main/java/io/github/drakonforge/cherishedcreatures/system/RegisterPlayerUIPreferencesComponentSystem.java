...
public class RegisterPlayerUIPreferencesComponentSystem extends HolderSystem<EntityStore> {
    ...
    public void onEntityAdd(@NonNullDecl Holder<EntityStore> holder,
        ...
        holder.ensureComponent(PlayerUIPreferencesComponent.getComponentType());
    }
